...
export const columns = [
  {
    ...
    header: () => h('button', {class: 'h-7  px-2  cursor-pointer text-center  inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground '}, [
      'ID',
      h(Icon, {icon: 'tabler:arrows-sort', width: '18', height: '18', class: 'ml-1'}),
    ]),
    cell: ({row}) => {
  ...
  {
    accessorKey: 'albumId',
    header: () => h('div', {class: 'h-7  px-2 cursor-pointer text-center  inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground'}, [
      'Альбом',
      h(Icon, {icon: 'tabler:arrows-sort', width: '18', height: '18', class: 'ml-1'}),
    ]),
